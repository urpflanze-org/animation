...
/* harmony export */   "clockOffset": () => (/* binding */ clockOffset),
/* harmony export */   "sinp": () => (/* binding */ sinp),
/* harmony export */   "cosp": () => (/* binding */ cosp),
/* harmony export */   "interpolateColorRGB": () => (/* binding */ interpolateColorRGB),
/* harmony export */   "interpolateColorHSL": () => (/* binding */ interpolateColorHSL)
/* harmony export */ });
/**
...
/* harmony export */ });
/* harmony import */ var _createInterpolator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
...
function createAnimation(simpleAnimation) {
    const interpolate = (0,_createInterpolator__WEBPACK_IMPORTED_MODULE_0__.createInterpolationCallback)(simpleAnimation);
    ...
    const animationFunction = (0,_createInterpolator__WEBPACK_IMPORTED_MODULE_0__.createInterpolator)(simpleAnimation.interpolator);
    const animation = {
        loop: 0,
        offset: 0,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createInterpolationCallback": () => (/* binding */ createInterpolationCallback),
/* harmony export */   "createInterpolator": () => (/* binding */ createInterpolator)
/* harmony export */ });
/* harmony import */ var _urpflanze_color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _urpflanze_color__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var bezier_easing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
/* harmony import */ var _Easings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
function createInterpolationCallback(simpleAnimation) {
    ...
    const colorInterpolation = simpleAnimation.colorTransitionMode === 'hue' ? _utilities__WEBPACK_IMPORTED_MODULE_3__.interpolateColorHSL : _utilities__WEBPACK_IMPORTED_MODULE_3__.interpolateColorRGB;
    ...
    for (let i = 0, len = from.length; i < len; i++) {
        if (typeof from[i] !== typeof to[i]) {
            ...
            if (typeof from[i] !== 'string') {
                ...
                const a = from[i];
                const b = to[i];
                const parsed_a = (0,_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__.parseColorAndConvert)(a);
                const parsed_b = (0,_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__.parseColorAndConvert)(b);
    ...
    switch (typeof type) {
        ...
        case 'string':
            switch (type) {
                ...
                default: {
                    if (type in _Easings__WEBPACK_IMPORTED_MODULE_2__.Easings) {
                        const easing = _Easings__WEBPACK_IMPORTED_MODULE_2__.Easings[type];
                        return (elapsed, duration) => easing(elapsed, 0, 1, duration);
                    }
                    return (elapsed, duration) => _Easings__WEBPACK_IMPORTED_MODULE_2__.Easings.linear(elapsed, 0, 1, duration);
                }
            }
        case 'object':
            switch (type.type) {
                ...
                case 'elasticOut':
                case 'elasticInOut': {
                    const easing = _Easings__WEBPACK_IMPORTED_MODULE_2__.Easings[type.type];
                ...
                case 'cubicBezier': {
                    const easing = bezier_easing__WEBPACK_IMPORTED_MODULE_1___default()(type.params[0], type.params[1], type.params[2], type.params[3]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "resolveSimpleAnimation": () => (/* binding */ resolveSimpleAnimation),
/* harmony export */   "Simple": () => (/* binding */ Simple),
/* harmony export */   "Compose": () => (/* binding */ Compose),
/* harmony export */   "Loop": () => (/* binding */ Loop),
/* harmony export */   "Static": () => (/* binding */ Static),
/* harmony export */   "UncontrolledLoop": () => (/* binding */ UncontrolledLoop)
/* harmony export */ });
/* harmony import */ var _composeAnimations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "composeAnimations": () => (/* binding */ composeAnimations)
/* harmony export */ });
/* harmony import */ var _urpflanze_color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _urpflanze_color__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _createAnimation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
function composeAnimations(simpleAnimations) {
    const animations = simpleAnimations.map(_createAnimation__WEBPACK_IMPORTED_MODULE_1__.createAnimation).filter(a => typeof a !== 'undefined');
    ...
    for (let i = 0, len = from.length; i < len; i++) {
        if (typeof from[i] !== typeof to[i]) {
            ...
            if (typeof from[i] !== 'string') {
                ...
                const parsed_b = (0,_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__.parseColorAndConvert)(b);
                if (typeof parsed_a !== 'undefined' && typeof parsed_b !== 'undefined') {
                    results.push((0,_utilities__WEBPACK_IMPORTED_MODULE_2__.interpolateColorRGB)(parsed_a, parsed_b, offset));
                }
            }
        }
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clock": () => (/* reexport safe */ _utilities__WEBPACK_IMPORTED_MODULE_1__.clock),
/* harmony export */   "clockOffset": () => (/* reexport safe */ _utilities__WEBPACK_IMPORTED_MODULE_1__.clockOffset),
/* harmony export */   "cosp": () => (/* reexport safe */ _utilities__WEBPACK_IMPORTED_MODULE_1__.cosp),
/* harmony export */   "interpolateColorHSL": () => (/* reexport safe */ _utilities__WEBPACK_IMPORTED_MODULE_1__.interpolateColorHSL),
/* harmony export */   "interpolateColorRGB": () => (/* reexport safe */ _utilities__WEBPACK_IMPORTED_MODULE_1__.interpolateColorRGB),
/* harmony export */   "sinp": () => (/* reexport safe */ _utilities__WEBPACK_IMPORTED_MODULE_1__.sinp),
/* harmony export */   "createAnimation": () => (/* reexport safe */ _createAnimation__WEBPACK_IMPORTED_MODULE_2__.createAnimation),
/* harmony export */   "createInterpolationCallback": () => (/* reexport safe */ _createInterpolator__WEBPACK_IMPORTED_MODULE_3__.createInterpolationCallback),
/* harmony export */   "createInterpolator": () => (/* reexport safe */ _createInterpolator__WEBPACK_IMPORTED_MODULE_3__.createInterpolator),
/* harmony export */   "Easings": () => (/* reexport safe */ _Easings__WEBPACK_IMPORTED_MODULE_4__.Easings),
/* harmony export */   "Compose": () => (/* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_5__.Compose),
/* harmony export */   "Loop": () => (/* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_5__.Loop),
/* harmony export */   "Simple": () => (/* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_5__.Simple),
/* harmony export */   "Static": () => (/* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_5__.Static),
/* harmony export */   "UncontrolledLoop": () => (/* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_5__.UncontrolledLoop),
/* harmony export */   "resolveSimpleAnimation": () => (/* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_5__.resolveSimpleAnimation)
/* harmony export */ });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _createAnimation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _createInterpolator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _Easings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11);
/* harmony import */ var _Animation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
...
var __webpack_exports__Easings = __webpack_exports__.Easings;
var __webpack_exports__Loop = __webpack_exports__.Loop;
var __webpack_exports__Simple = __webpack_exports__.Simple;
var __webpack_exports__Static = __webpack_exports__.Static;
var __webpack_exports__UncontrolledLoop = __webpack_exports__.UncontrolledLoop;
var __webpack_exports__clock = __webpack_exports__.clock;
var __webpack_exports__clockOffset = __webpack_exports__.clockOffset;
var __webpack_exports__cosp = __webpack_exports__.cosp;
var __webpack_exports__createAnimation = __webpack_exports__.createAnimation;
var __webpack_exports__createInterpolationCallback = __webpack_exports__.createInterpolationCallback;
var __webpack_exports__createInterpolator = __webpack_exports__.createInterpolator;
var __webpack_exports__interpolateColorHSL = __webpack_exports__.interpolateColorHSL;
var __webpack_exports__interpolateColorRGB = __webpack_exports__.interpolateColorRGB;
var __webpack_exports__resolveSimpleAnimation = __webpack_exports__.resolveSimpleAnimation;
var __webpack_exports__sinp = __webpack_exports__.sinp;
export { __webpack_exports__Compose as Compose, __webpack_exports__Easings as Easings, __webpack_exports__Loop as Loop, __webpack_exports__Simple as Simple, __webpack_exports__Static as Static, __webpack_exports__UncontrolledLoop as UncontrolledLoop, __webpack_exports__clock as clock, __webpack_exports__clockOffset as clockOffset, __webpack_exports__cosp as cosp, __webpack_exports__createAnimation as createAnimation, __webpack_exports__createInterpolationCallback as createInterpolationCallback, __webpack_exports__createInterpolator as createInterpolator, __webpack_exports__interpolateColorHSL as interpolateColorHSL, __webpack_exports__interpolateColorRGB as interpolateColorRGB, __webpack_exports__resolveSimpleAnimation as resolveSimpleAnimation, __webpack_exports__sinp as sinp };
